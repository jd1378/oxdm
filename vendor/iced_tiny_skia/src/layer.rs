...
impl Layer {
    ...
    pub fn draw_primitive_group(
        ...
        // oxdm fix: store the clip untransformed — the renderer
        // multiplies `clip_bounds() * transformation()` at draw time
        // (mirrors draw_text_group). Upstream 0.14.0 pre-multiplied
        // here too, double-translating every canvas clip.
    ...
    pub fn draw_primitive_cache(
        ...
        // oxdm fix: same double-transform as draw_primitive_group.
        ...
        let primitives = damage::list(
            ...
            |item| match item {
                ...
                Item::Group(primitives, group_bounds, transformation) => {
                    // oxdm fix: group_bounds is untransformed now.
                    let group_bounds = *group_bounds * *transformation;
                    primitives
                        .as_slice()
                        .iter()
